...
public class CourierResponses {
    ...
    public Response createCourier(String login, String password, String firstName) {
        return courierRequests.createCourier(new org.example.courier.Courier(login, password, firstName));
    }

    @Step("Отправка запроса на логин курьера")
    public Response loginCourier(String login, String password) {
        return courierRequests.loginCourier(new org.example.courier.Courier(login, password));
    }
